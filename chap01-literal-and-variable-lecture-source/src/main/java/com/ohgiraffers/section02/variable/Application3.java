...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        *   1-2. 예약어는 사용이 불가능하다. (자바에서 미리 사용하겠다고 compiler와 약속한 키워드 == 예약어)
        *   1-3. 변수명은 대소문자를 구분한다.
        *   1-4. 변수명은 숫자로 시작할 수 없다. (시작만 할 수 없고 숫자를 섞어서 사용하는 것은 가능하다.)
        *   1-5. 특수 기호는 '_'와 '$'만 사용 가능하다. (따라서 공백 사용 불가)
        *
        ...
        *   2-4. 한글로 변수명을 짓는 것이 가능하지만, 권장하지 않는다. (에러유발)
...
//        int 1age = 20;    //숫자로 시작해서 에러 발생.
        ...
        int _age = 20;
        int $harp = 20;     //'_' 와 '$'는 어느 위치에도 사용 가능
//        int sh@rp = 20;   //사용 가능한 특수문자 외에는 사용 불가능

        int aadaksdlskdfnkjnqweqwkrwelrkfkfnregklqef;

        int maxAge = 20;    //카멜케이스(camel-case) 방식
        int minAge = 10;
        ...
        boolean isAliyve = true;    //부정형 보다는 긍정혁이 더 나은 방식

...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        *     - 조건식 두 개가 모두 만족해야 true를 반환하기 때문에 앞의 결과가 false가 나오면
        ...
        * */
        ...
        //(조건문) ? true(참) : false(거짓)
        int result1 = (false && ++num1 > 0) ? num1 : num1;  //처음부터 false가 조건이라 거짓인 num2 반환
        System.out.println("&&실행 결과 : " + result1);       //10

        int num2 = 10;
        int result2 = (true || ++num2 > 0) ? num2 : num2;   //처음부터 true가 조건이라 참인 num2 반환

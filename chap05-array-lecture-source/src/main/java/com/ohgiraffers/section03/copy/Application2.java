...
public class Application2 {
    public static void main(String[] args) {
        ...
        */
        ...
        /* for문을 이용하여 인덱스 값 복사 */
        int[] coptFor = new int[originArr.length];
        for (int i = 0; i < originArr.length; i++) {
            coptFor[i] = originArr[i];
        }
        print("copyFor", coptFor);

...
public class Application {
    public static void main(String[] args) {
        ...
        * 3. 자동차는 처음에 멈춘 상태로 대기하고 있는다. (시동이 꺼져 있다.)
        ...
        *    1) CarDriver 클래스
        *       - 속성 : 자동차(Car 클래스)
        *       - 행위(메소드) : 시동걸기, 엑셀밟기, 브레이크밟기, 시동끄기
        *    2) Car 클래스
        *       - 속성 : 시동 상태, 현재 시속
        *       - 행위(메소드) : 시동걸기, 직진, 정지, 시동끄기
        * */
        ...
        while(true) {
            ...
            System.out.println("1.시동걸기\t2.전진\t3.정지\t4.시동끄기\t9.프로그램 종료");

package com.ohgiraffers.section07.kindsofvareable;
...
public class KindsOfVariable {      //클래스 영역의 시작
    ...
    * */
    ...
    public void testMethod(int num) {   //testMethod 메소드 영역의 시작
        /*
...
//      System.out.println(localNum);   //지역 변수는 선언 외에 다시 사용(호출)하기 위해서는 반드시 초기화가 돼야 한다.

        System.out.println(globalNum);  //전역 변수는 클래스 전역에서 사용 가능하다.
        System.out.println(staticNum);
    }   //testMethod 메소드 영역의 끝

    public void testMethod2() {    //testMethod2 메소드 영역의 시작
